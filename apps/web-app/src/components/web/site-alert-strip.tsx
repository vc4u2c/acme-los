...
export function SiteAlertStrip(): React.ReactElement | null {
  ...
  return (
    <div className="relative bg-[var(--brand)] text-[var(--brand-contrast)] after:pointer-events-none after:absolute after:bottom-0 after:left-4 after:right-4 after:h-px after:content-[''] after:bg-[linear-gradient(90deg,transparent,rgba(248,255,249,0.34),transparent)] sm:after:left-6 sm:after:right-6 lg:after:left-8 lg:after:right-8">
