...
export function SiteHeader({
  ...
  return (
    <header
      ref={headerRef}
      className="sticky top-0 z-40 bg-[color:var(--surface)/0.9] shadow-[0_18px_42px_-34px_var(--shadow-soft)] backdrop-blur-xl after:pointer-events-none after:absolute after:bottom-0 after:left-4 after:right-4 after:h-px after:content-[''] after:bg-[linear-gradient(90deg,transparent,var(--border-strong),transparent)] after:opacity-80 sm:after:left-6 sm:after:right-6 lg:after:left-8 lg:after:right-8 supports-[backdrop-filter]:bg-[color:var(--surface)/0.82]"
    >
      <SiteAlertStrip />
      {showMarketingNav ? (
        <div className="relative hidden bg-[color:var(--surface-strong)/0.88] lg:block after:pointer-events-none after:absolute after:bottom-0 after:left-6 after:right-6 after:h-px after:content-[''] after:bg-[linear-gradient(90deg,transparent,var(--border),transparent)] after:opacity-85 xl:after:left-8 xl:after:right-8">
