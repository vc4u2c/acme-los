...
deployment. Later local redeploys can omit the env var and reuse the existing
Key Vault secret. Keep the service app identifiers in source control because
they are not secret.
