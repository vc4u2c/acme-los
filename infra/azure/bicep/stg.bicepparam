...
param workloadVnetAddressSpace = '10.22.0.0/24'
param acaInfrastructureSubnetAddressPrefix = '10.22.0.0/27'
param privateEndpointSubnetAddressPrefix = '10.22.0.32/27'
